...
async def handle_mute_user(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await update.message.reply_text(to_monospace_uppercase("🔇 User muted"))
    except Exception as e:
        await update.message.reply_text(to_monospace_uppercase(f"❌ {e}"))
...
async def handle_unmute_user(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await update.message.reply_text(to_monospace_uppercase("🔊 User unmuted"))
    except Exception as e:
        await update.message.reply_text(to_monospace_uppercase(f"❌ {e}"))
